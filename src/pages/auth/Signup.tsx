            ...
            >
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-6 text-center">
                        <h1 className="text-3xl font-bold tracking-tight text-[var(--heading)]">Create your account</h1>
                        <p className="mt-1 text-sm text-gray-600 dark:text-neutral-400">Join and get moving fast.</p>
                    </div>
                    ...
                    <div className={`rounded-2xl p-6 shadow-xl ${PANEL} ${BORDER}`}>
                        ...
                        <p className="mt-6 text-center text-sm text-gray-600 dark:text-neutral-400">
                            ...
                            <Link to="/login" className="font-medium underline underline-offset-4 text-[var(--link)] hover:opacity-90">
                                Sign in
                            </Link>
                        </p>
                    </div>
