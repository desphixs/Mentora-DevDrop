...
import { Layers, Clock, Search, Printer, Download, Link as LinkIcon } from "lucide-react";
...
const SECTIONS: Section[] = [
  {
    ...
    body: <p className="text-sm text-[#2C3157] dark:text-[#C9D1FF]/85">By using Mentora, you agree to these Terms and all referenced policies. If you don’t agree, do not use the Services.</p>,
  },
  {
    id: "accounts",
    ...
    body: (
      <ul className="list-disc pl-5 text-sm text-[#2C3157] dark:text-[#C9D1FF]/85 space-y-1">
        ...
        <li>Mentors may be subject to verification and KYC requirements.</li>
  ...
  },
  {
    ...
    body: (
      <ul className="list-disc pl-5 text-sm text-[#2C3157] dark:text-[#C9D1FF]/85 space-y-1">
        <li>No illegal uses, harassment, or IP infringement.</li>
        <li>Follow booking flows, reschedule rules, and dispute processes.</li>
        <li>Respect other users and keep communications professional.</li>
      </ul>
    ),
  },
  {
    id: "fees",
    title: "4. Fees, payments & payouts",
    body: (
      <p className="text-sm text-[#2C3157] dark:text-[#C9D1FF]/85">
        Applicable commissions, payment processing fees, and payout schedules are shown in your dashboard. Taxes are your
        responsibility unless otherwise stated. See Finance → Taxes for more details.
      </p>
    ),
  },
  {
    id: "content",
    title: "5. Content & licenses",
    body: (
      <p className="text-sm text-[#2C3157] dark:text-[#C9D1FF]/85">
        You retain rights to your content; you grant us a limited license to host and display it to provide the Services.
        You represent you have the necessary rights to the content you upload.
      </p>
    ),
  },
  {
    ...
    body: (
      <p className="text-sm text-[#2C3157] dark:text-[#C9D1FF]/85">
        Services are provided “as is”. To the maximum extent permitted by law, we disclaim warranties and limit
        liability. Some jurisdictions don’t allow certain limitations—your rights may vary.
      </p>
    ),
  },
  {
    ...
    body: (
      <p className="text-sm text-[#2C3157] dark:text-[#C9D1FF]/85">
        We may suspend or terminate accounts for violations or risk. You may stop using the Services at any time.
      </p>
    ),
  },
  {
    ...
    body: (
      <p className="text-sm text-[#2C3157] dark:text-[#C9D1FF]/85">
        These Terms are governed by applicable local law. Disputes will be resolved via arbitration or courts as stated
        in your regional addendum.
      </p>
    ),
  },
  {
    ...
    body: <p className="text-sm text-[#2C3157] dark:text-[#C9D1FF]/85">We’ll post changes with a new “Last updated” date. Continued use means acceptance.</p>,
  },
  {
    id: "contact",
    title: "10. Contact",
    body: <p className="text-sm text-[#2C3157] dark:text-[#C9D1FF]/85">legal@mentora.example</p>,
  },
];
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[#0F132E] dark:text-[#E9ECFF]">Terms of Service</h1>
