...
const Fallback = ({ title }: { title?: string }) => <PageFallback title={title ?? "Loading…"} hint="Fetching page module…" variant="app" />;
const suspense = (node: React.ReactNode, title?: string) => <Suspense fallback={<Fallback title={title} />}>{node}</Suspense>;
...
const M_Availability = React.lazy(() => import("@/pages/app/mentor/Availability"));
...
// Mentor → Sessions
const M_SessionsList = React.lazy(() => import("@/pages/app/mentor/sessions/SessionsList"));
const M_SessionDetail = React.lazy(() => import("@/pages/app/mentor/sessions/SessionDetail"));
const M_SessionsRequests = React.lazy(() => import("@/pages/app/mentor/sessions/Requests"));
const M_SessionsUpcoming = React.lazy(() => import("@/pages/app/mentor/sessions/Upcoming"));
const M_SessionsPast = React.lazy(() => import("@/pages/app/mentor/sessions/Past"));

// Mentor → Finance
const M_Earnings = React.lazy(() => import("@/pages/app/mentor/finance/Earnings"));
const M_Payouts = React.lazy(() => import("@/pages/app/mentor/finance/Payouts"));
const M_Taxes = React.lazy(() => import("@/pages/app/mentor/finance/Taxes"));
const M_Invoices = React.lazy(() => import("@/pages/app/mentor/finance/Invoices"));

// Mentor → Offers
const M_OffersList = React.lazy(() => import("@/pages/app/mentor/offers/OffersList"));
const M_OfferDetail = React.lazy(() => import("@/pages/app/mentor/offers/OfferDetail"));
const M_NewOffer = React.lazy(() => import("@/pages/app/mentor/offers/NewOffer"));
const M_Packages = React.lazy(() => import("@/pages/app/mentor/offers/Packages"));
const M_GroupSessions = React.lazy(() => import("@/pages/app/mentor/offers/GroupSessions"));
const M_Coupons = React.lazy(() => import("@/pages/app/mentor/offers/Coupons"));

// Mentor → Mentees management (mentor-side)
const M_MenteesList = React.lazy(() => import("@/pages/app/mentor/mentees/MenteesList"));
const M_MenteeDetail = React.lazy(() => import("@/pages/app/mentor/mentees/MenteeDetail"));

// Mentor → Settings subsections
const M_SettingsIntegrations = React.lazy(() => import("@/pages/app/mentor/settings/Integrations"));
const M_SettingsNotifications = React.lazy(() => import("@/pages/app/mentor/settings/Notifications"));
const M_SettingsSecurity = React.lazy(() => import("@/pages/app/mentor/settings/Security"));
...
const ME_MentorDetail = React.lazy(() => import("@/pages/app/mentee/MentorDetail"));
...
// Mentee → Booking
const ME_SelectSlot = React.lazy(() => import("@/pages/app/mentee/booking/SelectSlot"));
const ME_Checkout = React.lazy(() => import("@/pages/app/mentee/booking/Checkout"));
const ME_Confirm = React.lazy(() => import("@/pages/app/mentee/booking/Confirm"));

// Mentee → Sessions
const ME_SessionsList = React.lazy(() => import("@/pages/app/mentee/sessions/SessionsList"));
const ME_SessionDetail = React.lazy(() => import("@/pages/app/mentee/sessions/SessionDetail"));

// Mentee → Billing
const ME_Invoices = React.lazy(() => import("@/pages/app/mentee/billing/Invoices"));
const ME_PaymentMethods = React.lazy(() => import("@/pages/app/mentee/billing/PaymentMethods"));
const ME_Subscriptions = React.lazy(() => import("@/pages/app/mentee/billing/Subscriptions"));
const ME_Credits = React.lazy(() => import("@/pages/app/mentee/billing/Credits"));

// Mentee → Settings subsections
const ME_Profile = React.lazy(() => import("@/pages/app/mentee/settings/Profile"));
const ME_Integrations = React.lazy(() => import("@/pages/app/mentee/settings/Integrations"));
const ME_Notifications = React.lazy(() => import("@/pages/app/mentee/settings/Notifications"));
const ME_Security = React.lazy(() => import("@/pages/app/mentee/settings/Security"));

// Mentee → Support
const ME_HelpCenter = React.lazy(() => import("@/pages/app/mentee/support/HelpCenter"));
const ME_Tickets = React.lazy(() => import("@/pages/app/mentee/support/Tickets"));
const ME_TicketDetail = React.lazy(() => import("@/pages/app/mentee/support/TicketDetail"));
    ...
    // ===== Mentor app (primary: /dashboard) =====
    {
        ...
        children: [
            ...
            // Mentor → Settings subsections
            {
                path: "settings",
                children: [
                    { path: "integrations", element: suspense(<M_SettingsIntegrations />) },
                    { path: "notifications", element: suspense(<M_SettingsNotifications />) },
